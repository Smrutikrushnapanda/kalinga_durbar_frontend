...
export default function AdminPage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative mx-auto flex min-h-screen w-full items-stretch overflow-visible border border-slate-200/80 bg-white/95 shadow-[0_28px_65px_rgba(15,23,42,0.09)]">
        <div
